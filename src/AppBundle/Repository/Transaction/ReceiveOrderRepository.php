...
class ReceiveOrderRepository extends EntityRepository
{
    ...
    {
        $query = $this->_em->createQuery('SELECT t FROM AppBundle\Entity\Transaction\ReceiveOrder t WHERE t.codeNumberMonth = :codeNumberMonth AND t.codeNumberYear = :codeNumberYear ORDER BY t.codeNumberOrdinal DESC');
