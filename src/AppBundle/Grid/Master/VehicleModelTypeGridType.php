...
class VehicleModelTypeGridType extends DataGridType
{
    ...
    public function buildData(DataBuilder $builder, ObjectRepository $repository, array $options)
    {
        ...
        $builder->processPage($repository->count($criteria['vehicleModelType'], $associations), function($offset, $size) use ($criteria) {
            $criteria['vehicleModelType']->setMaxResults($size);
            $criteria['vehicleModelType']->setFirstResult($offset);
        });
        
        $objects = $repository->match($criteria['vehicleModelType'], $associations);
